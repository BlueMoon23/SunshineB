 ...
 */
package app.sunshine.android.example.com.sunshine2.data;
...
public class WeatherContract {
    ...
    //relationship between adomain name and its website.
    public static final String CONTENT_AUTHORITY = "app.sunshine.android.example.com.sunshine2";

    //Use the Content authority to create the base of all Uris which apps will use to contact the content provider.
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        //The location setting string is what will be sent to the openweathermap as the location query.
        ...
        //In order to uniquely pinpoint the location, we use Lat and Lon.
